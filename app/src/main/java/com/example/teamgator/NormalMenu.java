...
public class NormalMenu extends RobotActivity implements RobotLifecycleCallbacks {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.normalmenu);
    ...
    public void onRobotFocusGained(QiContext qiContext) {
        ...
        String script = loadScriptFromTextFile("NormalScript");
